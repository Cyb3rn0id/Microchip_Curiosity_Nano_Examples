...
By default Curiosity nano runs at 3.3V even powered by USB: there is a controlled variable regulator on board software-controlled that generates the VTG (V Target). If you want to run the board @5V when you power it from USB you must change a parameter in the project configuration: 
